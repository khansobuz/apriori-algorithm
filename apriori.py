...
#the candidate_set C1 is generated by measuring the support_count of each item in the dataset
def stage_1(items, minimum_support_count):
    ...
    return c1, l1
#In this stage, candidate_set C2 is generated using Item_set L1 from the previous step.
# Check all subsets in itemset are frequent if not, remove respective itemset from the list.
# Item_set L2 is generated by comparing candidate_set C2 with minimum_support_count
def stage_2(l1, records, minimum_support_count):
    ...
    return c2, l2
 #candidate_set C3 is generated using Item_set L2 from the previous step
def stage_3(l2, records, minimum_support_count):
    ...
    return c3, l3
#candidate_set C4 is generated using Item_set L3 from the previous step
...
#To check subsets of an itemset are frequent,
# we should pass current stage itemset, the previous stage itemset, in this case, L1, and k-1.
